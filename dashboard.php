			...
			<div class="row mt-3">
				<div class="col-md-3">
					...
					<ul class="list-group categories-list">
			            <li class="list-group-item text-center"><a href="admin.php?p_id='Mobile' ">Admin</a></li>
			            <li class="list-group-item text-center"><a href="users.php?p_id='PC_Laptop' ">Users</a></li>
			            <li class="list-group-item text-center"><a href="ads_mngmnt.php?p_id='Vehicle' ">Ads</a></li>
			            <li class="list-group-item text-center"><a href="product.php?p_id='Property' ">Category</a></li>
			            <li class="list-group-item text-center"><a href="payment.php?p_id='Accessories' ">Payment</a></li>
			        </ul>
				</div>
