...
$post_create_query = "INSERT INTO post(post_user_email,post_title,post_price,post_contact,post_condition,post_category,post_location,post_image,post_details) ";
...
///updat_query
        ...
        $query_for_post_update .= "post_category = '{$category}', ";
		...
		<div class="col-md-6">
			<div class="jumbotron">
				<?php if(isset($_GET['edit'])){
					...
					echo "<h2 class='text-center'>Edit Your Add</h2>";
				}else{

					echo "<h2 class='text-center'>Post Your Ad</h2>";
				}
				...
				<form action="post_an_ad.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select name="category" id="">
							...
							<option value="Fashion_Health_Beauty">Fashion, Health & Beauty</option>
